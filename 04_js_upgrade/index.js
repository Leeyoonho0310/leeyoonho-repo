...
const dinnerMenu = ['라면', '볶음밥', '바질페스토', '냉동볶음밥'];
...
const str = 'fighting!!!';
console.log(...str); // 전개 방법이라 문자하나가 뚝뚝 끊김
...
// 객체를 합칠 때 동일한 key가 있다면 뒤에 있는 변수 객체 key의 value가 저장됨
let me = { ...me1, ...me2 };
console.log(me);
me.greeting();
...
function test(...val) {
  ...
  // v4 변수에 할당한 값이 없을 경우, 즉 인자가 3개 이하로 들어온 경우
...
// introduce('레일라', , '운동') // 함수 내부에서는 인자를 빈 채로 둘 수 없음
