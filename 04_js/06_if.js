...
/*
  1. 변수 x의 값과 첫 번째 case문의 값 3을 비교합니다.
...
switch (userType) {
  ...
  case "user":
    console.log("유저입니다.");
    // break 작성하지 않으면 case4를 실행하고 싶을 때 case 5까지 모두 실행됨
    // 해당 스코프를 빠져나가지 못하는 것
    // 원하는 코드가 실행된 이후 꼭 break를 사용해 스코프를 빠져나올 수 있도록 작성
    break;
...
// 이럴 때 점수를 10으로 나눈 몫을 찾아와 number로 전달, case 값도 변경
number = 78;
...
let fruit = "banana";
console.log(fruit === "banana" ? "바나나입니다." : "바나나가 아닙니다");
