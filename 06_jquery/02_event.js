...
// mouseover 이벤트 -> 해당 요소에 커서가 올라가면 실행
// $(".container").mouseover(() => {
//   console.log("커서 올라감");
// });

// // mouseout 이벤트 -> 해당 요소에 커서가 나가면 실행
// $(".container").mouseout(() => {
//   console.log("커서 나감");
// });

// hover 이벤트 -> css에서 더 많이 사용
// mouseover, mouseout를 한번에 지정
// 첫 번째 인자는 콜백함수는 mouseover 일 때 실행할 코드 작성
// 두 번째 인자는 콜백함수는 mouseout일 때 실행할 코드 작성
...
// keyup 이벤트 : 선택한 요소에서 키보드를 떼는 이벤트 발생한 경우
// 키보드를 누르고 있는 동안에는 이벤트가 발생하지 않음
// 사용자가 입력을 완료하거나 특정 키를 눌렀다가 뗄 때 필요한 동작 처리하는 사용
...
// keyup 이벤트
// on() : 이벤트를 걸겠다. addEventListener 와 비슷
$(".container[name=pw]").on("keyup", (e) => {
  console.log("e.key", e.key);
